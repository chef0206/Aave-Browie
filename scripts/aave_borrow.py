...
def main():
    ...
    # Now we can move to step 2 i.e. depositing 
    # Now to deposit we will be working with LendingPool contract
    # ABI
    # Address
...
def get_lending_pool():
    # ABI - interface of lending pool addresses provider
    # Address - adding both networks in brownie-config
